...
public class AdcPlusServoScenes {

    private static final int WIND_LINE_DURATION = 95;
    private static final int COUNTER_WIND_LINE_DURATION = 70;

    private AdcPlusServoScenes() {
    }

    public static void adcPlusServo(SceneBuilder scene, SceneBuildingUtil util) {
        scene.title("adc_plus_servo_ponder", I18n.get("twistermill.ponder.adc_plus_servo_ponder.title"));
        ...
        scene.overlay().showText(50)
                .text(I18n.get("twistermill.ponder.adc_plus_servo_ponder.text_1"))
        ...
        scene.overlay().showText(50)
                .text(I18n.get("twistermill.ponder.adc_plus_servo_ponder.text_2"))
                .colored(PonderPalette.OUTPUT)
        ...
        scene.overlay().showText(80)
                .text(I18n.get("twistermill.ponder.adc_plus_servo_ponder.text_3"))
                .colored(PonderPalette.OUTPUT)
        ...
        scene.idle(10);
        scene.overlay().showText(80)
                .text(I18n.get("twistermill.ponder.adc_plus_servo_ponder.text_4"))
                .colored(PonderPalette.OUTPUT)
                .pointAt(util.vector().centerOf(6, 1, 7));
        scene.idle(90);
        ...
        scene.overlay().showText(80)
                .text(I18n.get("twistermill.ponder.adc_plus_servo_ponder.text_5"))
        ...
        scene.overlay().showText(80)
                .text(I18n.get("twistermill.ponder.adc_plus_servo_ponder.text_6"))
                .colored(PonderPalette.OUTPUT)
        ...
        scene.overlay().showText(80)
                .text(I18n.get("twistermill.ponder.adc_plus_servo_ponder.text_7"))
                .colored(PonderPalette.OUTPUT)
        ...
        scene.overlay().showText(120)
                .text(I18n.get("twistermill.ponder.adc_plus_servo_ponder.text_8"))
