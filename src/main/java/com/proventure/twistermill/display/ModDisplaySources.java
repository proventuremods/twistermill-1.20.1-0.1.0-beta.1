...
public class ModDisplaySources {
    ...
    public static final DeferredHolder<DisplaySource, DisplaySource> WIND_ROTO_STATS =
            DISPLAY_SOURCES.register("wind_roto_stats", WindRotoDisplaySource::new);
    public static final DeferredHolder<DisplaySource, DisplaySource> SERVO_TWISTER_STATS =
            DISPLAY_SOURCES.register("servo_twister_stats", ServoTwisterDisplaySource::new);
    public static final DeferredHolder<DisplaySource, DisplaySource> WIND_ROTO_VERTICAL_STATS =
